...
from puzzlebot_vision.msg import SetPoint
from puzzlebot_vision.msg import Location
...
class Mobile_Robot():
    ...
    def __init__(self):
        ...
        #Implementacion de Image Processing
        self.flag = 'G'
        self.x = 1
        ...
        rospy.Subscribesr("/wl", Float32, self.wl_callback)
    ...
    def control(self, id, dt):
        ...
        self.velocity_pub.publish(self.vel/self.x)
    ...
    def run(self):
        ...
        if not self.shutdown:
            ...
            if self.target.id < self.target.limit:
                ...
                #print("--- Objetivo Actual: (distancia: {self.target.distance} , orientacion: {self.target.orientation})" )
